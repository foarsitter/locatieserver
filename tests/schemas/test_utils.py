...
def test_point() -> None:
    centroide_ll = Point(root="POINT(5.10696041 52.06415055)")

    assert centroide_ll.x == "5.10696041"
    assert centroide_ll.y == "52.06415055"

    centroide_ll = Point(root="POINT(10696041 06415055)")
